          ...
          <table className="w-full table-coins">
            <tbody>
              <tr>
                ...
                <th align="right" onClick={() => handleSort("current_price")}>
                ...
                <th align="right" onClick={() => handleSort("market_cap")}>
                  <div className="flex items-center justify-end whitespace-nowrap cursor-pointer">
                    Mkt Cap
                    <BiSort />
                  </div>{" "}
                </th>
              ...
              {dataResult?.map((item) => (
                ...
                >
                  ...
                  <td>
                    <div className="flex gap-1 items-center">
                      <Image
                        ...
                        alt=""
                      />{" "}
                      <span className="hidden sm:inline line-clamp-1 max-w-20">
                        {item?.name}
                      </span>
                      <span className="inline sm:hidden line-clamp-1 max-w-10">
                        {item?.symbol}
                      </span>
                    </div>
                  </td>
                  ...
                  <td align="right">
                    <span>
                      {formatNumber(item?.current_price, "token_price")}
                    </span>
                  </td>
                  <td align="right">
                    <span
